...
export default function Itanhaem(){
    ...
    async function buscaTempo(){
        const response = await Api.get('weather?array_limit=3&fields=only_results,temp,city_name,forecast,condition,max,min,description,moon_phase,date&key=b22ab5ba&city_name=Itanhaem,SP')
