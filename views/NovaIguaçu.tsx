...
export default function NovaIguaçu(){
    ...
    async function buscaTempo(){
        const response = await Api.get('https://api.hgbrasil.com/weather?array_limit=3&fields=only_results,temp,forecast,max,min,date,condition,moon_phase&key=1ab2802d&city_name=Nova_Iguaçu,RJ')
